		...
		var iatObj =
		{
			...
			category1 : {
				...
				title : {
					...
					css : {color:'#336600','font-size':'0.8em'}, //Style of the category title.
			...
			category2 :	{
				...
				//Stimulus css
				stimulusCss : {color:'#336600','font-size':'1.3em'}
			},
			attribute1 :
			{
				name : 'Bad',
				...
				//Stimulus css
				stimulusCss : {color:'#0000FF','font-size':'1.3em'}
			},
			attribute2 :
			{
				name : 'Good',
			...
			remindErrorTextTouch : '<p align="center" style="font-size:"0.5em"; font-family:arial">' +
			'If you make a mistake, a red <font color="#ff0000"><b>X</b></font> will appear. ' +
			...
			keysCss : {'font-size':'0.2em', 'font-family':'courier', color:'#000000'},
			//Text and style for the separator between the top and bottom category labels.
			orText : 'or', 
			orCss : {'font-size':'0.5em', color:'#000000'},
